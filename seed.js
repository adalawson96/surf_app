...
spots = [
    {country: countries[0]._id, location: 'Peahi, Maui', name: 'Jaws', season: 'Dec-March', waterTemp: 75, waveType: 'reef', image: "https://www.surf-forecast.com/locationmaps/Jaws.10.gif", spotImage: "https://img.redbull.com/images/c_limit,w_1500,h_1000,f_auto,q_auto/redbullcom/2021/12/22/j7f1bleglww0gsrbjl66/wsl-big-wave-jaws-weather-window-day-1-art", description:'Jaws is probably the largest, heaviest, and fastest wave of the Pacific Ocean producing waves ranging between 30 and 80 feet.'},

    {country: countries[1]._id,location: 'Tamarindo', name: 'Pico', season: 'Dec-April', waterTemp: 82, waveType: 'rock/reef',  image: "https://i.imgur.com/VDOFwb0.png", spotImage: "https://witchsrocksurfcamp.com/wp-content/uploads/2018/10/pico-grande-surf-spot-tamarindo-costa-rica.jpg.webp", description: 'Pico is marked by a lava-thumb reef. The wave ~50 meters long best wind direction light offshore.'},
    
    {country: countries[2]._id,location: 'Playa Colorado', name: 'Panga Drops', season: 'April-September', waterTemp: 77, waveType: 'reef', image: "https://i.imgur.com/rzqd7Ga.png", spotImage: "https://s3.amazonaws.com/nsr-production/photos/attachments/565392235d39057fe460a91f4a34fd0a6ae7d5fd.jpg?1523520829", description: 'Pangas enjoys offshore bathymetry, but it is a horseshoe reef rather than perfectly crafted sandbars.'},
];
